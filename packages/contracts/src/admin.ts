...
export const adminPermissions = [
  ...
  'aliases:write',
  'sources:write',
  'external_profiles:read',
  'external_profiles:write',
  'handles:read',
  'handles:write',
  'handles:critical',
  'candidates:read',
  ...
  'imports:commit',
  'ingestion_runs:read',
  'ingestion_runs:write',
  'source_configurations:read',
  'source_configurations:write',
  'source_checkpoints:reset',
  'source_locks:release',
  'releases:read',
  'releases:write',
  'releases:approve',
  'releases:publish',
...
export const approvalActionTypes = [
  ...
  'external_profile.update_critical',
  'external_profile.delete_critical',
